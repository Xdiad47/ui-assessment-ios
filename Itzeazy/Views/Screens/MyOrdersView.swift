...
// MARK: - MyOrdersView
//
// This screen used to render a static/mock order list (kept below, commented
// out, for reference). It now reuses the app's shared CitizenServicesWebView
// (the same WebView used for RTO/Passport/Visa/etc.) to show the user's real
// orders, loaded via the generate-web-login-token flow (WebLoginViewModel)
// with redirect path "/profile/allorders".
struct MyOrdersView: View {
    var onBackToHome: (() -> Void)? = nil
    @Environment(\.presentationMode) private var presentationMode
    @StateObject private var webLoginVM = WebLoginViewModel()

    private let ordersURL = "https://itzeazy.in/profile/allorders"
    ...
    private func loadOrders() {
        ...
        webLoginVM.generateToken(urlString: ordersURL, title: "My Orders")
    }
...
// MARK: - Original static "My Orders" UI (superseded by the live WebView above)
//
// struct MyOrdersViewLegacy: View {
//     var onBackToHome: (() -> Void)? = nil
//     @Environment(\.presentationMode) private var presentationMode
