...
struct PassportInitialView: View {
    @Environment(\.presentationMode) private var presentationMode
    @StateObject private var viewModel = PassportInitialViewModel()
    ...
    var body: some View {
        GeometryReader { proxy in
            ZStack(alignment: .top) {
                ...
                NavigationLink(
                    destination: PassportDetailView(
    ...
    private var selectionCard: some View {
        ...
        // picker fields never blend into a Dark Mode background.
        .colorScheme(.light)
    }
